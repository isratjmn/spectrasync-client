	...
	return (
		<div className="bg-indigo-100 dark:bg-gray-800 h-screen overflow-hidden flex items-center justify-center">
			<div className="bg-indigo-200 lg:w-6/12 md:7/12 w-10/12 shadow-3xl rounded-xl">
				<div className="mt-6">
					<h1 className="text-xl text-deep-purple-900 font-extrabold text-center">
						Create Your{" "}
						<span className="font-bolder text-2xl">
				...
				>
					...
					<button
						type="submit"
						className="bg-gradient-to-b from-deep-purple-800 to-purple-900 font-medium p-2 md:p-4 text-white uppercase w-full rounded"
					>
						Register
					</button>
					<div className="mt-4">
						<p className="text-center text-sm text-gray-600">
							...
							<Link
								to="/login"
								className=" text-deep-purple-900 font-bold hover:underline focus:text-gray-800 focus:outline-none ms-1 text-md"
							>
								Login
							</Link>
						</p>
